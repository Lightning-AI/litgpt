...
We are able to demonstrate instruction-finetuning Lit-StableLM 3B on the [Alpaca](https://github.com/tatsu-lab/stanford_alpaca) dataset on a **single GTX 3060 GPU**. If using 8 GPUs, finetuning can be completed in under 1 hour.
...
```bash
python finetune_adapter.py --pretrained_dir checkpoints/stabilityai/stablelm-base-alpha-3b
```
...
python generate_adapter.py \
    ...
    --pretrained_dir checkpoints/stabilityai/stablelm-base-alpha-3b
```
Output:
```
