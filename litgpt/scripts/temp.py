...
def copy_weights_hf_llama(
    ...
    if config.mlp_class_name in ("Phi3MLP",):
        weight_map.update(
            {
                "model.layers.{}.mlp.gate_up_proj.weight": "transformer.h.{}.mlp.gate_up_proj.weight",
                "model.layers.{}.mlp.down_proj.weight": "transformer.h.{}.mlp.down_proj.weight",
                "model.layers.{}.post_attention_layernorm.weight": "transformer.ln_f.weight",
