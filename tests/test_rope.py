...
def test_rope(lit_stablelm):
    ...
    ours_cos_cached, ours_sin_cached = lit_stablelm.build_rope_cache(seq_len, head_size, device=x.device, dtype=x.dtype)
    ...
    ours_x_rope = lit_stablelm.apply_rope(x, ours_cos_cached, ours_sin_cached)
